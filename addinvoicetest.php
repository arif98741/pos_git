                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control btn-success" name="sell_id" id="sell_id"
                                                   type="hidden" value="<?php echo $invoice; ?>">
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <tr>
                                <td><a class="btn btn-success" href="#" id="add_invo_pro_btn"><i
                                                class="lnr lnr-plus-circle"></i>&nbsp;Add New</a></td>

                                <td><input type="text" class="form-control autocomplete" id="product_id"
                                           placeholder="Product ID" tabindex="2"></td>
