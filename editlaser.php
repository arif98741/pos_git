                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input name="date" class="form-control" type="date" tabindex="1"
                                                   value="<?php echo $help->formatDate($transdata['date'], 'Y-m-d'); ?>">
                                            <input name="laserid" class="form-control" type="hidden"
                                                   value="<?php echo $transdata['serial']; ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input name="debit" id="debit" class="form-control" type="number"
                                                   value="<?php echo $transdata['debit']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input name="credit" id="credit" class="form-control" type="number"
                                                   value="<?php echo $transdata['credit']; ?>"
                                                   placeholder="Credit/Cash In" tabindex="6">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="category" class="form-control" id="transcategory"
                                                    tabindex="2">
                                                    ...
                                                    while ($result = $status->fetch_assoc()) { ?>
                                                        ...
                                                        <?php if ($result['id'] == $transdata['category']): ?>
                                                            <option value="<?php echo $result['id']; ?>"
                                                                    type="<?php echo $result['category_type']; ?>"
                                                                    selected=""><?php echo $result['category_name']; ?></option>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input name="description" id="" class="form-control"
                                                   value="<?php echo $transdata['description']; ?>"
                                                   placeholder="Description" tabindex="7">
                                        </div>
                                    </div>
                                    <div class="col-md-6 submit-buttom">

                                        <input type="submit" value="Update" name="updatelaser" class="btn btn-success"
                                               tabindex="8">
