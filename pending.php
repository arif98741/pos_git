                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Browser: activate to sort column ascending">Registant ID
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Platform(s): activate to sort column ascending">Name
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Engine version: activate to sort column ascending">Batch
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                    ...
                                    while ($row = $status->fetch_object()) {
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <img src="../photo/<?php echo $row->photo; ?>" alt="" width="40px"
                                                         height="40px">
                                                <?php endif; ?>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-warning" disabled><i
                                                            class="fa fa-refresh"></i></a>
                                                <a href="viewregistant.php?duty=view&id=<?php echo $row->id; ?>"
