                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="name"
                                           value="<?php echo $member_data['name']; ?>" placeholder="Enter Name"
                                           required="">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="designation"
                                           value="<?php echo $member_data['designation']; ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="address"
                                           value="<?php echo $member_data['address']; ?>" placeholder="Enter Address">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="contact"
                                           value="<?php echo $member_data['contact']; ?>" placeholder="Enter Contact">
                                </div>
                            </div>
