                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input name="groupname" class="form-control" type="text"
                                                   value="<?php echo ucfirst($groupdata['groupname']); ?>" required="">
                                        </div>
                                    </div>

                                    <div class="col-md-6 submit-buttom">

                                        <input type="submit" name="updategroup" value="Save Group"
                                               class="btn btn-success">
                                        <input type="hidden" name="groupid" value="<?php echo $groupdata['groupid']; ?>"
                                               class="btn btn-success">
