            ...
            <form action="colorlist.php" method="post">
                <div class="col-md-4">
                    <div class="form-group">
                        <input name="colorname" class="form-control" type="text"
                               value="<?php echo ucfirst($colordata['colorname']); ?>" required="">
                    </div>
                </div>
                ...
                <div class="col-md-6 submit-buttom">
                    ...
                    <input type="hidden" name="colorid" value="<?php echo $colordata['colorid']; ?>"
