...
<?php if (Session::get('status') !== 'admin') {
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="lnr lnr-chart-bars"></i> &nbsp;INVOICE REPORT</h1>
            <ol class="breadcrumb">
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="printfiles/sale/invoicereport.php" method="POST">
                                    ...
                                    <div class="col-md-offset-3 col-md-6">
                                        <div class="form-group">
                                            <input type="submit" name="showinvoicereport" class="btn btn-success"
                                                   value="All Sales">
                                            <input type="submit" name="showinvoiceaccordingtocustomer"
                                                   class="btn btn-primary" value="Customer Wise">
                                        </div>
                                    </div>
