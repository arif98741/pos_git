                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input name="invoice_no"
                                                       value="<?php echo $ext->generatePurchaseID(); ?>"
                                                       class="form-control" placeholder="Purchase Number" required=""
                                                       readonly="">
                                            </div>
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <table id="invoice_form_table" class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="1" style="text-align: center;"><input type="hidden"
                                                                                                       name="addinvoice"><b
                                                                class="wholetotal"></b></td>
                                            ...
                                            <button class="btn btn-success add_new_invoice_table_row"
                                                    title="Click To Add Product in Purchase List"
