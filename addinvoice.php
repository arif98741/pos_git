                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control btn-success" name="sell_id" id="sell_id"
                                                   type="hidden" value="<?php echo $ext->generateInvoiceID(); ?>">

                                            <select name="cus_id" class="form-control select2"
                                                    id="cus_dropdown_addinvoice">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="" class="form-control" id="customer_id"
                                                   placeholder="Customer ID"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="" class="form-control" id="customer_name"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-success" style="">
                                                    ...
                                                    <input type="number" class="form-control text-right"
                                                           style="text-align: center;" id="discount" name="discount"
                                                           tabindex="1"/>
                                                ...
                                                <div class="form-group">
                                                    <label>Payable</label>
                                                    <input type="text" class="form-control text-right" id="payable"
                                                           value="0" name="payable" readonly=""/>

                                                    <input type="hidden" class="form-control text-right" id="grandtotal"
                                                           value="0" name="grandtotal"/>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="number" class="form-control text-right"
                                                           style="text-align: center;" id="dlcharge" name="dlcharge"
                                                           required="" tabindex="2"/>
                                                </div>
                                                <div class="form-group has-success">
                                                    <label class="control-label" for="inputSuccess1">PAID</label>

                                                    <input type="number" class="form-control text-right" id="paid"
                                                           name="paid" style="text-align: center;" required=""
                                                           tabindex="4"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <input type="number" class="form-control text-right" id="vat"
                                                           name="vat" style="text-align: center;" required=""
                                                           tabindex="3"/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Due</label>
                                                    <input type="number" class="form-control text-right" id="due"
                                                           name="due" readonly="" value="0"/>
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <tr>
                                <td width="20%"><a class="btn btn-success btn-block" href="#" id="add_invo_pro_btn"><i
                                                class="lnr lnr-plus-circle"></i>&nbsp;Add New</a></td>


                                <td width="40%">
                                    <select id="product_id"
                                            class="form-control select2 select2_dropdown select2-hidden-accessible"
                                    ...
                                    ORDER BY tp.product_name ASC";
                                        ...
                                        if ($status) {
                                            ...
                                            while ($result = $status->fetch_assoc()) {
                                                ?>
                                                <option productsearhkey=""
                                                        productgroupid="<?php echo $result['product_group']; ?>"
                                                        value="<?php echo $result['product_id']; ?>"><?php echo $result['product_name']; ?></option>
                                ...
                                <td width="20%">
                                    ...
                                    <input type="hidden" name="addpurchase" class="form-control" id="product_quantity"
                                           placeholder="Quantity">
                                </td>
                                ...
                                <td width="20%">
                                    ...
                                    <input type="hidden" class="form-control" id="purchase_price"
