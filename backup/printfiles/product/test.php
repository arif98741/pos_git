    ...
    <body>
        ...
        <div class="wraper">
            <table width="100%" border="0" class="header">
                <tr>
                    <td width="8%" align="left" valign="top"><a href="dashboard.php"><span class="user_panel "><img src="../photo/photos2018-01-12-15-07-03_5a58c10707ece.png" class="img_div" width="60" height="60"  alt=""/></span></a></td>
                    <td width="68%" height="67" align="left" valign="middle"><div class="title-1">বসুরহাট সরকারী উচ্চ বিদ্যালয়</div>

                        <div class="title-3">কর্মচারী তালিকা</div></td>
                    <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">সর্বমোট শিক্ষক সংখ্যা: (0)  জন </div></td>
                </tr>
            </table>
