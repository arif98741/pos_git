            ...
            <?php if (isset($_POST['reportallproduct'])): ?>
                <table width="100%" border="0" class="header">
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">Didar Tiles and Factory Ltd</div>
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">Didar Tiles and Factory Ltd</div>
                            ...
                            <div class="title-3">Products Report By Type - <?php
                                ...
                                ?></div></td>
                        <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Products: (<?php echo $pri->TotalProducts("select * from tbl_product where product_type = '{$_POST["product_type"]}'") ?>) </div></td>
                    </tr>
                </table>
                <div class="line-4"></div>
                <div class="line-3"></div>
            ...
            <?php if (isset($_POST['reportbybrand'])): ?>
                <table width="100%" border="0" class="header">
                    <tr>
                        ...
                        <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Products: (<?php echo $pri->TotalProducts("select * from tbl_product where product_brand = '{$_POST["product_brand"]}'") ?>) </div></td>
                    </tr>
                </table>
                <div class="line-4"></div>
                <div class="line-3"></div>
