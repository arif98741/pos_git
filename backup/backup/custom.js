    ...
    * */
    ...
    $(function () { //invoice management
        ...
        $('#inv_detail').delegate('.product_list', 'change', function (e) {
            ...
            t.find('.purchase').val(d['sale_price']);
    ...
    $(function(){
        ...
        $('#add_invo_pro_btn').click(function(){
            ...
            var pro_id = $('#product_group_list_dropdown_add_sale').val();
      ...
      // });
        ...
        $("#discunt, #vat, #dlcharge, #paid").keyup(function() {
           calculation();
        });
        ...
        function calculation(){
            ...
            var payable = grandtotal + balance;
