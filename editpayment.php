                            ...
                            <form action="<?php echo BASE_URL; ?>billpay.php" method="post"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="customer_id" class="form-control" type="text"
                                                   ...
                                                   value="<?php echo $payment_data['customer_id']; ?>" readonly="">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="customer_name" class="form-control" type="text"
                                                   ...
                                                   value="<?php echo $payment_data['customer_name']; ?>" readonly="">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="amount" class="form-control" type="text"
                                                   value="<?php echo round($payment_data['amount']); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="method" class="form-control"
                                                   value="<?php echo $payment_data['method']; ?>" placeholder="">
                                        </div>
                                    ...
                                    <div class="col-md-offset-4 col-md-6 submit-button">
                                        ...
                                        <input type="submit" value="Update Payment" name="updatepayment"
