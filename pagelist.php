                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Browser: activate to sort column ascending" width="20%">Title
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="Platform(s): activate to sort column ascending" width="30%">
                                        Description
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="CSS grade: activate to sort column ascending" width="10%">Date
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="CSS grade: activate to sort column ascending" width="20%">Photo
                                    </th>
                                            ...
                                            <td>
                                                <?php if ($row->photo == '' || $row->photo == null): ?>
                                                    <img src="../photo/committee/default.png" alt="" width="80px"
                                                         height="80px">
                                                <?php else: ?>
                                                    <img src="../photo/page/<?php echo $row->photo; ?>" alt=""
                                                         width="150px" height="100px">
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <a href="editpage.php?duty=edit&id=<?php echo $row->id; ?>"
