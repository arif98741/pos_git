                ...
                <table width="100%" border="0" class="header">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">Didar Tiles and Factory Ltd</div>
                                ...
                                <div class="title-3">Sales Report By all Products</div></td>
                            <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Products: (<?php echo $pri->TotalProducts("select * from tbl_sell"); ?>) </div></td>
                        </tr>
                    </table>
                ...
                <table width="100%" border="0" class="header">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">Didar Tiles and Factory Ltd</div>
                                ...
                                <div class="title-3">Sales Report by Group</div></td>
                            <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Products: (<?php echo $pri->TotalProducts("select * from tbl_sell"); ?>) </div></td>
                        </tr>
                    </table>
                    <div class="line-4"></div>
                ...
                <table width="100%" border="0" class="header">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">Didar Tiles and Factory Ltd</div>
                                ...
                                <div class="title-3">Sales Report by Product Type</div></td>
                            <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Products: (<?php echo $pri->TotalProducts("select * from tbl_sell"); ?>) </div></td>
                        </tr>
                    </table>
                    <div class="line-4"></div>
                ...
                <table width="100%" border="0" class="header">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">Didar Tiles and Factory Ltd</div>
                                ...
                                <div class="title-3">Sales Report by Product Brand</div></td>
                            <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Products: (<?php echo $pri->TotalProducts("select * from tbl_sell"); ?>) </div></td>
                        </tr>
                    </table>
                    <div class="line-4"></div>
