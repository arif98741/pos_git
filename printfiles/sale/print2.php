                ...
                <table width="100%" border="0" class="header">
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">Didar Tiles and Factory Ltd</div>
                                ...
                                <div class="title-3">Purchase  Report by All</div></td>
            ...
            <?php if (isset($_POST['purchasereportbycolor'])): ?>
                ...
                <table width="100%" border="0" class="header">
                    <tr>
                        ...
                        <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Purchased Products: (<?php echo $pri->TotalProducts("SELECT * FROM tbl_invoice,tbl_invoice_products,tbl_product,tbl_color WHERE tbl_invoice.invoice_number = tbl_invoice_products.invoice_id AND tbl_invoice_products.product_id = tbl_product.product_id AND tbl_product.color = tbl_color.colorid AND tbl_color.colorid = '{$_POST['product_color']}' "); ?>) </div></td>
                    </tr>
                </table>
                <div class="line-4"></div>
                <div class="line-3"></div>
