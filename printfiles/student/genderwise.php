        ...
        <div class="wraper">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle">
                                ...
                                <div class="title-3">
                                    ...
                                    Batch - <?php echo $_POST['batch'];?> <br/>
                                    Academic - <?php echo $_POST['academic'];?> <br/>
                                </div></td>
                ...
                <table class="TFtable" id="datatable" >
                      ...
                      <tbody>
                        ...
                        $stmt = $db->link->query("select * from registration where status='approved' and gender='$gender' and batchyear='$batch' and academic='$academic'") or die( $db->link->error)." ".__LINE__;
                            if ($stmt) { $i = 0;
