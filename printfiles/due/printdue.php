                ...
                <table width="100%" border="0" class="header">
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1">explore Point of Sales</div>
                            ...
                            <td width="24%" align="right" valign="middle" nowrap="nowrap"><div class="title-2">Total Products: (<?php echo $pri->TotalProducts("select ts.sell_id,ts.customer_id,ts.grand_total,ts.paid,tc.customer_name,ts.due,tc.contact_no,ts.date from tbl_sell ts join tbl_customer tc on 
            ts.customer_id = tc.customer_id order by ts.serial desc limit 1"); ?>) </div></td>
                        </tr>
                    </table>
