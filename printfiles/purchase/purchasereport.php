                ...
                <table width="100%" border="0" class="header">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1"><?php echo Session::get('company_name'); ?></div>
                                ...
                                <div class="title-3">Purchase Report</div> From <?php echo $_POST['starting']?> to </div><?php echo $_POST['ending'];?></div></td>
                                <?php 
                ...
                <table width="100%" border="0" class="header">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1"><?php echo Session::get('company_name'); ?></div>
                                ...
                                <div class="title-3">Purchase Report by Group - <?php echo $pro->showGroupById($_POST['groupid'])['groupname']; ?> <br/> </div>From <?php echo $_POST['starting']?> to </div><?php echo $_POST['ending'];?></div></td>
                                <?php 
                ...
                <table width="100%" border="0" class="header">
                    ...
                    <tr>
                        ...
                        <td width="68%" height="67" align="left" valign="middle"><div class="title-1"><?php echo Session::get('company_name'); ?></div>
                                ...
                                <div class="title-3">Purchase Report by Supplier - <?php echo $pro->showBrandById($_POST['brandid'])['supplier_name']; ?> <br/></div>From <?php echo $_POST['starting']?> to </div><?php echo $_POST['ending'];?></div></td>
                                <?php 
