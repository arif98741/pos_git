            ...
            <table width="100%" border="0" class="header">
                <tr>
                    ...
                    <td width="68%" height="67" align="left" valign="middle"><div class="title-1"><?php echo Session::get('company_name'); ?></div>
                            ...
                            <div class="title-3">Stock Report by Supplier - <?php echo $supplier_data->supplier_name; ?></br></div></td>
                        <td width="24%" align="right" valign="middle" nowrap="nowrap"></div></td>
                    </tr>
            </table>
            ...
            <table width="100%" border="0" class="header">
                <tr>
                    ...
                    <td width="68%" height="67" align="left" valign="middle"><div class="title-1"><?php echo Session::get('company_name'); ?></div>
                            ...
                            <div class="title-3">Stock Report by Group - <?php echo $groupdata->groupname; ?></br></div></td>
                        <td width="24%" align="right" valign="middle" nowrap="nowrap"></div></td>
                    </tr>
            </table>
